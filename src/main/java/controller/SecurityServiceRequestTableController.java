...
public class SecurityServiceRequestTableController extends Controller implements Initializable {
    @FXML
    ...
    private ObservableList<SecurityRequest> data;
    ...
    public void revolveRequestButtonClicked(javafx.event.ActionEvent actionEvent) {
        SecurityRequest sr = (SecurityRequest) dataTable.getSelectionModel().getSelectedItem();
        sr.resolve();
        updateTable();
    }

    private void updateTable() {
        data = SecurityRequest.getAllServiceRequests();
