...
public class Vector2DTest {
    ...
    public void testVectorThing() {
        ...
        assertEquals(EnumDirectionType.LEFT, v1.getSignedLengthOfCrossProduct2D(v2));
    }
    @Test
    public void testVectorThingRight() {
        Vector2D v1 = new Vector2D(0,0,1,0);
        Vector2D v2 = new Vector2D(0,0,0,1);
        assertEquals(EnumDirectionType.RIGHT, v2.getSignedLengthOfCrossProduct2D(v1));
    }
    ...
    public void testVectorThingStraightish() {
        ...
        Vector2D v2 = new Vector2D(0,0,1000,9);
        assertEquals(EnumDirectionType.STRAIGHT, v2.getSignedLengthOfCrossProduct2D(v1));
    }
}
